...
export default function App() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black font-sans">
      {/* Language & Sound Switchers - Only on Start Screen */}
      {gameState === 'START' && (
        ...
        <div className="fixed top-0 left-0 w-full p-6 flex justify-between items-start pointer-events-none z-10">
          ...
          <div className="flex items-start gap-4">
            ...
            <button 
              ...
              className="pointer-events-auto p-3 glass rounded-full hover:bg-white/20 transition-colors shadow-xl"
            >
      ...
      {/* Info Trigger Button - Bottom Right Corner */}
